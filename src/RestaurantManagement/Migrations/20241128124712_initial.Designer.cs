...
namespace RestaurantManagement.Migrations
{
    ...
    [Migration("20241128124712_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestaurantManagement.Models.Card", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RestaurantManagement.Models.CardItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RestaurantManagement.Models.RestaurantRoles", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ba57071b-ede0-416e-8954-2e515d13d945"),
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = new Guid("55957282-695a-4db2-afd1-8a75782a0d26"),
                            Name = "Customer",
                            NormalizedName = "CUSTOMER"
                        },
                        new
                        {
                            Id = new Guid("0193b259-cfb0-4cc4-b1f0-d8dd01016d6d"),
                            Name = "Chef",
                            NormalizedName = "CHEF"
                        },
                        new
                        {
                            Id = new Guid("e18af6a2-2f36-4f54-a6c1-0742bee37a46"),
                            Name = "Manager",
            ...
            modelBuilder.Entity("RestaurantManagement.Models.Card", b =>
                {
                    b.HasOne("RestaurantManagement.Models.Customer", "Customer")
                        .WithOne("Card")
                        .HasForeignKey("RestaurantManagement.Models.Card", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RestaurantManagement.Models.CardItem", b =>
                {
                    b.HasOne("RestaurantManagement.Models.Card", "Card")
                        .WithMany("CartItems")
